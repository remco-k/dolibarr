...
class FactureRec extends CommonInvoice
{
	...
	public $fields = array(
		...
		'rule_for_lines_dates' => array('type' => 'varchar(255)', 'label' => 'RuleForLinesDates', 'enabled' => 'getDolGlobalInt("FACTUREREC_SUPPORT_RULE_FOR_LINES")', 'visible' => 1, 'position' => 153, 'arrayofkeyval' => array('prepaid' => "Prepaid", 'prepaid_alignedmonth' => "Prepaid (Aligned month)", 'postpaid' => "Postpaid"), 'default' => 'prepaid'),
